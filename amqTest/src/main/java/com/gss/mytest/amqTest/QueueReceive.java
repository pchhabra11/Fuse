...
public class QueueReceive implements MessageListener {
	...
	public final static String QUEUE = "FOO.BAR";
	...
	public void onMessage(Message msg) {
		try {
			...
			if (msgText.equalsIgnoreCase("hello world")) {
				...
				// The "Hello World" message which we received is not committed,
				// hence it's undelivered and goes back to the TestQ
				qsession.rollback();
			} else {
				System.out.println("\n\t " + msgText);
				// Here we are committing the session to acknowledge that we
				// have received the message from the TestQ
				qsession.commit();
			}
